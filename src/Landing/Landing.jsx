...
const WhatsAppFloat = () => (
    <a
        href="https://wa.me/5493415936396?text=Hola!%20Quiero%20m%C3%A1s%20informaci%C3%B3n"
        className="gh-whatsapp-float"
        target="_blank"
    ...
    return (
        <div className="gh-landing gh-theme-light">
            ...
            <Section
                ...
                title="Hecho para la gestión real de gimnasios"
                subtitle="GymHour nació a partir de una necesidad real: la de un dueño de gimnasio que necesitaba una forma más simple y ordenada de gestionar rutinas, usuarios, cuotas y el día a día de su negocio."
                className="gh-section-soft"
            >
                <div style={{ maxWidth: '820px', margin: '0 auto', textAlign: 'center' }}>
                    <p className="gh-muted" style={{ fontSize: '20px', marginBottom: '32px' }}>
                        En conjunto, desarrollamos una solución pensada desde la experiencia, para ayudar a gimnasios y entrenadores a ahorrar tiempo en gestión y dedicar más energía a lo que realmente importa: estar cerca del alumno y mejorar su experiencia.
                    </p>
                    
                    <div className="gh-about-grid">
                        <div className="gh-about-card">
                            <span className="gh-about-icon">🎯</span>
                            <h4 className="gh-about-card-title">Experiencia Real</h4>
                            <p className="gh-about-card-desc">Diseñado por y para dueños de gimnasios, resolviendo los problemas del día a día.</p>
                        </div>
                        <div className="gh-about-card">
                            <span className="gh-about-icon">⚡</span>
                            <h4 className="gh-about-card-title">Simplicidad</h4>
                            <p className="gh-about-card-desc">La tecnología debe facilitar el trabajo, no complicarlo. Todo a un clic de distancia.</p>
                        </div>
                        <div className="gh-about-card">
                            <span className="gh-about-icon">🤝</span>
                            <h4 className="gh-about-card-title">Acompañamiento</h4>
                            <p className="gh-about-card-desc">Estamos cerca tuyo para que puedas estar más cerca de tus alumnos.</p>
                        </div>
                    </div>

                    <p className="gh-muted" style={{ fontSize: '20px', fontWeight: '600', color: 'var(--text)', marginTop: '64px' }}>
                        Creemos que la tecnología tiene que ordenar, simplificar y acompañar, no complicar.
                    </p>
                </div>
            </Section>
